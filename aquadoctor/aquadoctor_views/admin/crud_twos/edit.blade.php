        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route(config('app.crud_two_admin') . '.update', $crud_two->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="meta_description_{{ $locale }}" class="form-control @error('meta_description_' . $locale) is-invalid @enderror" name="meta_description_{{ $locale }}">{{ old('meta_description_' . $locale, $crud_two->{'meta_description_' . $locale}) }}</textarea>
