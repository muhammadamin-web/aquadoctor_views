...
<section class="section" >
    ...
    <section class="content">
        ...
        <div class="container">
        <h1 class="first_block1_title" style="margin-bottom: 50px;"><span>{{ __('app.filtered_by_tag') }}</span>  @foreach ($tags as $tag)
        <span style="color: #5050FE !important;">  #{{ $tag->{'name_' . app()->getLocale()} }}</span>
        @endforeach</h1>
